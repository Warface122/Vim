...
nnoremap <C-S-C> "+y   " Копирование в системный буфер
vnoremap <C-S-C> "+y   " Копирование выделенного текста в системный буфер
imap <C-S-V> <C-R>+    " Вставка текста из буфера обмена
